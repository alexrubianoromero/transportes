...
<body id="divInicialInventarios"  style="background-color:#333333;">
            ...
            <div class="row" >
                ...
                <div class="col-lg-6 offset-lg-3 mt-5"  >
                    <div class="card" style="background-color:#fcb900;padding:20px;">
                        <div class="card-body">
                            <div align="center">
                                <img src="vistas/logo.png" width="60%;" style="border-radius:10px;">
                                <div class="mt-4"><h2>CONTROL TRANSPORTES</h2></div>    
                            </div>
    ...
    <script src="dist/js/adminlte.min.js"></script>
        ...
        <script src="conductores/js/conductores.js"></script>  
        <script src="viajes/js/viajes.js"></script>  
